...
/*            function goToNext(time) {
            ...
            // Add a flag to track whether the key is held down
            ...
            this.safeBind($(document), 'keydown', function(e) {
                ...
                if (code == 32) { // Spacebar key code
                    if (!keyReleased) return false; // Ignore if the key is still held down
            
                    keyReleased = false; // Set the flag to indicate the key is being held
                    ...
                    // If the task is complete, process the results
                    if (t.currentWord > t.stoppingPoint) {
                        t.processSprResults();
                        t.finishedCallback(t.resultsLines);
                    }
            ...
            this.safeBind($(document), 'keyup', function(e) {
                if (e.keyCode == 32) { // Spacebar key code
                    keyReleased = true; // Reset the flag
                }
            });
